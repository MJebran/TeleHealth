...
namespace TeleHealthAPI.Controllers
{
    ...
    public class FileController : ControllerBase
    {
        ...
        // public async Task<ActionResult<TeleHealthAPI.Models.File>> UploadFile([FromForm] FileUploadDto uploadDto)
        // {
        ...
        //     using var context = _contextFactory.CreateDbContext();
        //     var caseItem = await context.Cases.FindAsync(uploadDto.CaseId);
        //     if (caseItem == null)
        //     {
        //         return NotFound(new { message = "Case not found." });
        //     }

        //     var uploadsFolderPath = Path.Combine(_environment.WebRootPath, "uploads", "cases", uploadDto.CaseId.ToString());
        //     Directory.CreateDirectory(uploadsFolderPath);
        //     var filePath = Path.Combine(uploadsFolderPath, uploadDto.File.FileName);
        ...
        //     {
        //         CaseId = uploadDto.CaseId,
        //         FilePath = $"/uploads/cases/{uploadDto.CaseId}/{uploadDto.File.FileName}",
