      ...
      >
        ...
        <div className="card-body" style={{ backgroundColor: "#F7F8FD" }}>
          ...
          >
            ...
            Have questions or need support? Reach out to us, and we’ll assist
            you promptly!
          </p>
          <ul className="list-group list-group-flush">
            ...
            >
              ...
              <strong></strong>&nbsp;
              <a
                href="mailto:support@telehealthapp.com"
            ...
            >
              <i
                ...
                style={{ color: "#74C0C3" }}
              ></i>
              <strong></strong>&nbsp; Timani Project, Kabul, Afghanistan
            </li>
          </ul>
            ...
            <div className="d-flex justify-content-center">
              <div className="text-center">
                <i
                  ...
                  style={{ color: "#74C0C3", fontSize: "1.5rem" }}
                ></i>
                <p
                  style={{
                    color: "#373D44",
