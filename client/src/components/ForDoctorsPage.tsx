        ...
        <Col>
          <Card className="shadow-lg border-0">
            <Card.Body>
              ...
              <ul>
                <li>Expand your reach to patients beyond geographical boundaries.</li>
                <li>Manage virtual appointments with ease and flexibility.</li>
                <li>Securely maintain and access patient records online.</li>
                <li>Improve patient outcomes with seamless collaboration with Scribe Interns.</li>
              </ul>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col>
          <Card className="shadow-lg border-0">
            <Card.Body>
              ...
              <ol>
                <li>Access the platform and review cases submitted by Scribe Interns.</li>
                <li>Choose cases that match your specialty and expertise.</li>
                <li>Provide detailed prescriptions and treatment plans securely.</li>
                <li>Collaborate with Scribe Interns to ensure effective communication with patients.</li>
              </ol>
            </Card.Body>
          </Card>
        </Col>
