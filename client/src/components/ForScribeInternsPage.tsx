          ...
          <Card className="shadow-lg border-0">
            <Card.Body>
              ...
              <ul>
                ...
                <li>
                  Enhance your medical knowledge by working with experienced
                  doctors.
                </li>
                <li>
                  Play a vital role in streamlining communication between
          ...
          <Card className="shadow-lg border-0">
            <Card.Body>
              ...
              <ol>
                ...
                <li>
                  Record all necessary medical information provided by the
                  patient.
                </li>
                <li>
                  Share cases securely with doctors for review and treatment
                  plans.
                </li>
                <li>
                  Relay doctors' prescriptions and treatment advice back to
                  patients.
                </li>
              </ol>
            </Card.Body>
